...
IMG_MAP = {
    "media/image2.png": "/assets/flowchart.png",
    "media/image3.png": "/assets/table2.png",
    "media/image4.png": "/assets/table3.png",
    "media/image5.png": "/assets/table4.png",
    "media/image6.png": "/assets/table5.png",
}
...
def add_front_matter(lines, version):
    ...
    lines.insert(2, f"title: 'EV CHARGE {version} Documentation'\n")
...
def add_download_button(doc, version):
    ...
    btn = (
        f"<button name='download' onclick=\"location.href='../EV CHARGE {version} Model "
