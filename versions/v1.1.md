...
<!-- Added by: j.schmidt, at: Mon Sep 25 14:38:12 CEST 2023 -->
...
| Type               | **Level 1 or Level 2** | **Level 2**                 | **Level 2** | **Battery swapping** | **Level 2**     | **Level 2**  | **DC** | **DC** |     |
...
\\(Active\ charger\ utilization\ (in\ percentage\ of\ the\ time) = a*\ln(EV\ stock\ share) + b\ \\) (1)
...
$$\#\ chargers\ of\ a\ certain\ location,\ type\ and\ capacity\ (for\ the\ user\ group) = \#\ vehicles\ in\ the\ user\ group*\ per\ \text{year}\ \left( \frac{\text{km}}{\text{year}} \right)\ *v\text{ehicle\ efficiency\ }\left( \frac{\text{kWh}}{\text{km}} \right)*share\ of\ energy\ coming\ from\ this\ charger\ category\ for\ the\ user\ group(\%)*\frac{1}{\text{power\ delivery\ ratio\ }\left( \% \right)*\ rated\ power\ output\ \left( \text{kW} \right)*utilization\ share\ \left( \% \right)}*\ \frac{1}{24\ hrs*365\ days}$$
...
$$\#\ \text{battery\ swapping\ station\ of\ a\ certain}\ type\ (for\ the\ user\ group) = \#\ vehicles\ in\ the\ user\ group*\ \text{VKT\ per\ vehicle\ }\text{per\ year\ }\left( \frac{\text{km}}{\text{year}} \right)\ *vehicle\ efficiency\ \left( \frac{\text{kWh}}{\text{km}} \right)*\text{share\ of\ energy\ coming\ from\ this\ }\text{battery\ swapping}\text{\ category\ for\ the\ user\ group}\ (\%)*\frac{1}{\text{Battery\ capacity\ }\left( \text{kWh} \right)*(1 - \text{Battery}\text{mininum}{\text{state\ of\ charge}\ \left( \% \right))}}*\ \frac{1}{\#\ Swaps\ per\ battery\ swapping\ station\ per\ day\ (\frac{1}{\text{day}})}\text{\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }*\ \frac{1}{365\ days}$$
...
| Charger Location       | Home    | Home      | Workplace | Depot   | Public overnight | Public overnight | Public destination | Public destination | Public destination | Public en-route | Public en-route |
| ---------------------- | ------- | --------- | --------- | ------- | ---------------- | ---------------- | ------------------ | ------------------ | ------------------ | --------------- | --------------- |
| Dwelling Type          | House   | Apartment |           |         |                  |                  |                    |                    |                    |                 |                 |
...
|         |         |            | Yes                          | No               | NA                                |                               | 100%       | PC\_BEV\_home\_nocommuter\_global          |
|         |         |            | No                           | Yes              | Yes                               |                               | 100%       | PC\_BEV\_nohome\_commuter\_work\_global    |
|         |         |            | No                           | Yes              | No                                |                               | 100%       | PC\_BEV\_nohome\_commuter\_nowork\_global  |
|         |         |            | No                           | No               | NA                                |                               | 100%       | PC\_BEV\_nohome\_nocommuter\_work\_global  |
|         |         | PHEV       | Yes                          | Yes              | Yes                               |                               | 70%        | PC\_PHEV\_home\_commuter\_work\_global     |
|         |         |            | Yes                          | Yes              | No                                |                               | 70%        | PC\_PHEV\_home\_commuter\_nowork\_global   |
|         |         |            | Yes                          | No               | NA                                |                               | 55%        | PC\_PHEV\_home\_nocommuter\_global         |
|         |         |            | No                           | Yes              | Yes                               |                               | 45%        | PC\_PHEV\_nohome\_commuter\_work\_global   |
|         |         |            | No                           | Yes              | No                                |                               | 15%        | PC\_PHEV\_nohome\_commuter\_nowork\_global |
|         |         |            | No                           | No               | NA                                |                               | 15%        | PC\_PHEV\_nohome\_nocommuter\_work\_global |
| LCV     |         | BEV        | No                           | NA               | NA                                | Yes                           | 100%       | LCV\_BEV\_depot\_nohome                    |
|         |         |            | Yes                          | NA               | NA                                | No                            | 100%       | LCV\_BEV\_nodepot\_home                    |
|         |         |            | No                           | NA               | NA                                | No                            | 100%       | LCV\_BEV\_nodepot\_nohome                  |
|         |         | PHEV       | No                           | NA               | NA                                | Yes                           | 55%        | LCV\_PHEV\_depot\_nohome                   |
|         |         |            | Yes                          | NA               | NA                                | No                            | 15%        | LCV\_PHEV\_nodepot\_home                   |
|         |         |            | No                           | NA               | NA                                | No                            | 55%        | LCV\_PHEV\_nodepot\_nohome                 |
| PC      | Taxi    | BEV        | No                           | NA               | NA                                | Yes                           | 100%       | Taxi\_BEV\_depot\_nohome                   |
|         |         |            | Yes                          | NA               | NA                                | No                            | 100%       | Taxi\_BEV\_nodepot\_home                   |
|         |         |            | No                           | NA               | NA                                | No                            | 100%       | Taxi\_BEV\_nodepot\_nohome                 |
|         |         | PHEV       | No                           | NA               | NA                                | Yes                           | 70%        | Taxi\_PHEV\_depot\_nohome                  |
|         |         |            | Yes                          | NA               | NA                                | No                            | 70%        | Taxi\_PHEV\_nodepot\_home                  |
|         |         |            | No                           | NA               | NA                                | No                            | 15%        | Taxi\_PHEV\_nodepot\_nohome                |
