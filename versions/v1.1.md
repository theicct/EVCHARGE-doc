...
| ---------- | ------------------ | ------------ | -------------- |---------------------|---------------|
| BEV + PHEV | Workplace          | Level 2      | 2%             | 15%                 | 3.6           |
| BEV + PHEV | Public overnight   | Level 2      | 2%             | 20%                 | 4.8           |
| BEV + PHEV | Public destination | Level 2      | 2%             | 10%                 | 2.4           |
| BEV only   | Public destination | DCFC         | 2%             | 10%                 | 2.4           |
| BEV only   | Public en-route    | DCFC         | 2%             | 10%                 | 2.4           |
